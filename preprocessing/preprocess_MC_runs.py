...
def run():
    ...
    mc_simulations = pd.read_csv('pace_baseline_erf_projection_samples.csv')
    mc_simulations = clean_mc_sims(mc_simulations)

    # Concatenate the two dataframes
    mc_simulations = pd.concat([bau_contrails, mc_simulations], ignore_index=True)

    mc_simulations.to_csv('final/sens_inventory_long.csv', index=False)
