...
def main():
    SSPs = ['ssp119']
    slcp_ems = pd.read_csv('/Users/j.benoit/Documents/Applied_Projects/FaIR Climate Projections/data/off-road/off-road_sub_sectors.csv')

    ems = pd.read_csv('rcmip-emissions-annual-means-v5-1-0_original.csv')
    conc = pd.read_csv('rcmip-concentrations-annual-means-v5-1-0_original.csv')
    forc = pd.read_csv('rcmip-radiative-forcing-annual-means-v5-1-0_original.csv')
    ...
    forc.to_csv('off_road/off_road_rcmip-radiative-forcing-annual-means-v5-1-0.csv', index=False)
    ems.to_csv('off_road/off_road_rcmip-emissions-annual-means-v5-1-0.csv', index=False)
    conc.to_csv('off_road/off_road_rcmip-concentrations-annual-means-v5-1-0.csv', index=False)
    ...
    ems_long.to_csv('off_road/off_road_rcmip-emissions-annual-means-v5-1-0_long.csv', index=False)
    # forc_long = forc.melt(id_vars=['Model', 'Scenario', 'Region', 'Variable', 'Unit', 'Mip_Era', 'Activity_Id'], var_name='Year', value_name='ems')
    # forc_long.to_csv('off_road_rcmip-forcing-annual-means-v5-1-0_long.csv', index=False)
